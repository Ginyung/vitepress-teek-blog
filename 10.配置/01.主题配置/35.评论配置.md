---
url: /vitepress-teek-blog/10.配置/01.主题配置/35.评论配置.md
---
...
```ts {2,6-7,9,11-12,14,25-37}
// .vitepress/theme/index.ts
import Teek, { artalkContext, giscusContext, walineContext, twikooContext } from "vitepress-theme-teek";
