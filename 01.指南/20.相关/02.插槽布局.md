---
url: /vitepress-teek-blog/01.指南/20.相关/02.插槽布局.md
---
...
* `teek-footer-info`&#x20;
* `teek-footer-group-before`&#x20;
* `teek-footer-group-after`&#x20;
...
* `teek-article-banner-before` ：等于 VitePress 的 `layout-top` 插槽
* `teek-article-banner-after`&#x20;
* `teek-article-banner-info-top`&#x20;
* `teek-article-banner-info-bottom`&#x20;
