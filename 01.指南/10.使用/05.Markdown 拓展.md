---
url: /vitepress-teek-blog/01.指南/10.使用/05.Markdown 拓展.md
---
...
* `effect` 的文件要求必须是 `.vue` 文件，写 `demo/button-info` 或者 `demo/button-info.vue` 都可以
* `file` 默认的文件后缀是 `.vue`，如果您的文件后缀不是 `.vue`，请指定文件后缀，如 `demo/button-primary.md`
